...
namespace PixelCrushers.DialogueSystem.Extras
{
    ...
    public class TextlineDialogueUI : StandardDialogueUI
    {
        ...
        public override void Open()
        {
            ...
            if (headingText != null)
            {
                ...
                {
                    headingText.text = DialogueLua.GetActorField( Field.LookupLocalizedValue(conversation.fields, "Title"), "Display Name").asString;
                }
            }
